...
# 2 "tests/char_pointer_arg.cpp" 2
...
# 3 "tests/char_pointer_arg.cpp" 2
...
# 49 "./watchman.h" 2
# 7 "tests/char_pointer_arg.cpp" 2

int a(char* buff2){
    char buff[10];
    { sprintf(buff, "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/bin/sh"); __asm__ __volatile__( "mov -0xc(%ebp),%edx\n" "xor %gs:0x14,%edx;\n" "je . + 13\n" "mov 0x2c(%esp),%edx\n" "xor %gs:0x14,%edx;\n" "je . + 7\n" "CALL __stack_chk_fail\n" ); };
    system(buff2);
}
