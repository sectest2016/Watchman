...
# 1 "secure_common.h" 1
# 24 "secure.h" 2
# 1 "secure_aggressive_stack_check.h" 1
# 25 "secure.h" 2
# 1 "secure_instrumentation.h" 1
# 26 "secure.h" 2
# 1 "secure_object_protection.h" 1
# 27 "secure.h" 2
# 1 "secure_super_aggressive_stack_checking.h" 1
# 28 "secure.h" 2
# 7 "adjacent_buffer.cpp" 2

int a(){
    char COOKIE1[1] = { 0x00 }; char COOKIE2[2] = { 0x00, 0xff }; char COOKIE4[4] = { 0x00, 0xff, 0xff, 0xff }; char COOKIE6[6] = { 0x00, 0xff, 0xff, 0xff }; char COOKIE8[8] = { 0x00, 0xff, 0xff, 0xff }; char COOKIE10[10] = { 0x00, 0xff, 0xff, 0xff }; char COOKIE16[16] = { 0x00, 0xff, 0xff, 0xff }; char COOKIE32[32] = { 0x00, 0xff, 0xff, 0xff }; char COOKIE64[64] = { 0x00, 0xff, 0xff, 0xff }; void* COOKIES[9] = {COOKIE1, COOKIE2, COOKIE4, COOKIE6, COOKIE8};
