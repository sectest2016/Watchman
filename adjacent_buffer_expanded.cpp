...
# 11 "./watchman.h" 2
# 25 "./watchman.h"
# 1 "./secure_manual_stack_check.h" 1
# 26 "./watchman.h" 2
# 1 "./secure_common.h" 1
...
# 1 "./secure_super_aggressive_stack_checking.h" 1
# 35 "./watchman.h" 2
# 7 "tests/adjacent_buffer.cpp" 2

int a(){
    int ___numCookies = 7; char ___COOKIE4[4] = { 0x00, 0xff, 0xff, 0xff }; char ___COOKIE6[6] = { 0x00, 0xff, 0xff, 0xff }; char ___COOKIE8[8] = { 0x00, 0xff, 0xff, 0xff }; char ___COOKIE10[10] = { 0x00, 0xff, 0xff, 0xff }; char ___COOKIE16[16] = { 0x00, 0xff, 0xff, 0xff }; char ___COOKIE32[32] = { 0x00, 0xff, 0xff, 0xff }; char ___COOKIE64[64] = { 0x00, 0xff, 0xff, 0xff }; char* ___COOKIES[] = {___COOKIE4, ___COOKIE6, ___COOKIE8, ___COOKIE10, ___COOKIE16, ___COOKIE16, ___COOKIE32, ___COOKIE64};
    char buff_bad[25] = "aaaaaaaaaa/bin/sh";

    char buff[10];
    char buff2[4] = "dir";
    sprintf(buff, "%s", buff_bad); for(int ___onCookie = 0; ___onCookie < ___numCookies; ___onCookie++){ if(___COOKIES[___onCookie][0] != 0x00)pwned("stack smashing caught early"); };
    system(buff2);
}
